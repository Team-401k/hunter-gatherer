...
def upgrade() -> None:
    ...
    op.add_column('orders', sa.Column('user_ids', postgresql.ARRAY(sa.String()), nullable=False))
    ...
    op.add_column('orders', sa.Column('foreign_transaction_id', sa.String(), nullable=True))
    op.drop_constraint('fk_orders_user_id_users', 'orders', type_='foreignkey')
    op.create_foreign_key(op.f('fk_orders_sku_products'), 'orders', 'products', ['sku'], ['sku'])
    ...
    op.alter_column('users', 'date_renewed',
               existing_type=sa.DATE(),
               type_=sa.DateTime(),
               existing_nullable=True)
...
def downgrade() -> None:
    ...
    op.add_column('users', sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False, primary_key=True, unique=True))
    op.add_column('users', sa.Column('emergency_phone', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('users', sa.Column('date_expired', sa.DATE(), autoincrement=False, nullable=True))
    op.add_column('users', sa.Column('usps', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('users', sa.Column('types', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('users', sa.Column('emergency_contact', sa.VARCHAR(), autoincrement=False, nullable=True))
    ...
    op.add_column('orders', sa.Column('stripe_paypal_id', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('orders', sa.Column('type', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('orders', sa.Column('method', sa.VARCHAR(), autoincrement=False, nullable=True))
